...
合计: **1,247** 行代码（覆盖前 5 种语言、共 **17** 个文件）。
...
- **上游仓库**: <https://github.com/bschaatsbergen/cidr>
- **官网**: <https://formulae.brew.sh/formula/cidr>
- **许可证**: MIT
...
- **Star**: 242 · **Fork**: 11 · **开放 issue**: 20 · **贡献者**: 7

## 累计统计

- **发布数**: 16 · **已合并 PR**: 118 · **开放 PR**: 6 · **已关闭 issue**: 15 · **开放 issue**: 5 · **提交数**: 337
...
| last180d | 2026-03-16 | 0 | 1 | 5 | 0 | 1 | 1 |
| 360d | 2025-09-17 | 0 | 5 | 6 | 0 | 1 | 5 |
| last720d | 2024-09-22 | 1 | 19 | 6 | 0 | 2 | 45 |
...
cidr 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `cidr` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/cidr.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T04:54:30Z._
